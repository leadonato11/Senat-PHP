      ...
      <li class="nav-item">
        ...
        <div id="collapseFoodGroups" class="collapse" aria-labelledby="headingUtilities"
          ...
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="../Grupos de Alimentos/gestionAlimentos.html">Gestionar grupos</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <form action="crearUsuario.php" method="POST" enctype="multipart/form-data" class="form-inline d-flex flex-column align-items-start">
                  ...
                  <h3>Datos del usuario</h3>
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" placeholder="Ingrese su apellido..."
                        aria-describedby="basic-addon1" name="apellido">
                    </div>
                    <div class="input-group">
                      <div class="input-group-prepend">
                    ...
                    <div class="input-group">
                      ...
                      <input type="number" class="form-control" placeholder="Ingrese su DNI..."
                        aria-describedby="basic-addon1" title="DNI (sin puntos ni espacios)" name="dni">
                    </div>
                    <div class="input-group">
                      <div class="input-group-prepend">
                        <span class="input-group-text bg-dark text-light labelMacroMicroNut"
                      ...
                      <input type="email" class="form-control" placeholder="Ingrese su correo..."
                        aria-describedby="basic-addon1" name="correo">
                    </div>
                    <div class="input-group">
                      <div class="input-group-prepend">
                        <span class="input-group-text bg-dark text-light labelMacroMicroNut" id="basic-addon1">
              ...
              <div class="row m-3 justify-content-center">
                <div class="col-lg-12 col-md-12 col-sm-12">
                  ...
                  <!-- Guardar Usuario Modal-->
                    <div class="modal fade" id="guardarUsuarioModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                      aria-hidden="true">
