                ...
                <div class="col-lg-6 col-md-4 col-sm-12">
                  <div class="alimento__dataInicial">
                    ...
                    <div class="input-group">
                      ...
                      <input type="number" step="any" min="0" class="form-control inputCantGeneral" name="cant" value="<?php echo $db['cant'] ?>" placeholder="Cantidad porción gral..." aria-label="cantidadAlimento" aria-describedby="basic-addon1" title="Cantidad porción gral...">
