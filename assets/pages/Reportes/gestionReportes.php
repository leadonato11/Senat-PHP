      ...
      <li class="nav-item">
        ...
        <div id="collapseSurveys" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="../Encuestas/encuestasActivas.html">Gestión de encuestas</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div id="collapseReports" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="reportes.html">Ver reportes</a>
          </div>
        </div>
      </li>
      <hr class="sidebar-divider">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTableAlimentos" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <tr>
                      <td class="text-center">Calcio</td>
                      <td class="text-center">Encuesta Calcio invierno 2019</td>
                      <td class="text-center">11/07/2021</td>
                      <td class="text-center">1782</td>
                      <td class="text-center">
                        <a class="btn btn-success btn-sm" href="#" role="button"><i class="fas fa-file-download"></i></a>
                  ...
                  <tfoot>
                    <tr>
                      <th class="text-center" colspan="7">Última actualización el 24/08/2021 a las
                        23:11 pm.</th>
                    </tr>
                  </tfoot>
                </table>
