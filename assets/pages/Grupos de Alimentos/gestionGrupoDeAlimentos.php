...
<head>
  ...
  <title>SENAT | Gestión de grupo de alimentos</title>
</head>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Busca, consulta y agrega nuevos grupos de alimentos al sistema. Si desea más información puede
