                ...
                <div class="p-5">
                  ...
                  <form class="user" action="index.php" method="POST">
                    <div class="form-group">
                      <input type="text" name="u" class="form-control form-control-user" id="loginInputUser"
                        placeholder="Ingresa tu usuario..." required>
                    </div>
                    <div class="form-group">
                      <input type="password" name="p" class="form-control form-control-user" id="loginInputPassword"
